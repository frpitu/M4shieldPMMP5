...
class EventListener implements Listener
{
    ...
    private const IPV4_REGEX = '/\b(?:\d{1,3}\.){3}\d{1,3}\b/';
    private const IPV6_REGEX = '/(?:[0-9a-fA-F]{1,4}:){7}[0-9a-fA-F]{1,4}/';
    ...
    private function processBlockedWords(string $msg): string
    {
    ...
    private function hasBlockedWordsInName(string $name): bool
    {
    ...
    private function hasIpAddress(string $msg): bool
    {
        return preg_match(self::IPV4_REGEX, $msg) || preg_match(self::IPV6_REGEX, $msg);
    }

    private function blockIpLeak(string $msg): string
    {
        $msg = preg_replace(self::IPV4_REGEX, str_repeat($this->getConfigValue("ipleakblock.replacementChar", "*"), 7), $msg);
        $msg = preg_replace(self::IPV6_REGEX, str_repeat($this->getConfigValue("ipleakblock.replacementChar", "*"), 7), $msg);
